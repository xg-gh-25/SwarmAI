...
- [ ] 1. Extract shared file utilities into `desktop/src/utils/fileUtils.ts`
  - [ ] 1.1 Create `desktop/src/utils/fileUtils.ts` with `fileIcon()`, `fileIconColor()`, `gitStatusBadge()`, and `gitStatusColor()` extracted from `TreeNodeRow.tsx`
  ...
  - [ ] 1.2 Update `TreeNodeRow.tsx` to import from `fileUtils.ts`
...
- [ ] 2. Create line-based diff algorithm in `desktop/src/utils/lineDiff.ts`
  - [ ] 2.1 Implement `computeLineDiff(oldText, newText): DiffLine[]` using LCS
...
- [ ] 4. Add new props and state to FileEditorModal
  - [ ] 4.1 Extend `FileEditorModalProps` and `FileEditorState` interfaces
  ...
  - [ ] 4.2 Add new internal state variables to `FileEditorModal` component
...
- [ ] 5. Implement modal header enhancements (icon, badge, breadcrumb, attach)
  - [ ] 5.1 Add file-type icon and git status badge to the modal header
  ...
  - [ ] 5.2 Implement BreadcrumbBar in the modal header
  ...
  - [ ] 5.4 Implement Attach to Chat button
...
- [ ] 6. Implement line numbers gutter
  - [ ] 6.1 Create LineGutter sub-component inside FileEditorModal
...
- [ ] 7. Checkpoint — Verify header and gutter
  - Ensure all tests pass (`cd desktop && npm test -- --run`), ask the user if questions arise.

- [ ] 8. Implement diff view toggle
  - [ ] 8.1 Implement DiffView sub-component inside FileEditorModal
  ...
  - [ ] 8.2 Add "Show Changes" toggle button and diff mode logic
...
- [ ] 9. Implement in-file search
  - [ ] 9.1 Implement search match computation utility
  ...
  - [ ] 9.2 Implement SearchBar sub-component
  ...
  - [ ] 9.3 Wire Cmd+F / Ctrl+F keyboard shortcut and search highlighting
...
- [ ] 10. Checkpoint — Verify diff and search
  - Ensure all tests pass (`cd desktop && npm test -- --run`), ask the user if questions arise.

- [ ] 11. Wire new props through ThreeColumnLayout
  - [ ] 11.1 Update `fileEditorState` in ThreeColumnLayout to include `gitStatus`
  ...
  - [ ] 11.2 Pass `onAttachToChat` and `isAttached` props to FileEditorModal
...
- [ ] 12. Theme compatibility verification
  - [ ] 12.1 Ensure all new UI elements use CSS variables from `index.css`
