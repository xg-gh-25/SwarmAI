...
**Design System Reference**: See `desktop/src/` for current implementation
...
**1. Agent Chat Interface**
   - Location: `desktop/src/pages/ChatPage.tsx`
...
**2. Agent Management**
   - Location: `desktop/src/pages/AgentsPage.tsx`
...
**3. Skill Management**
   - Location: `desktop/src/pages/SkillsPage.tsx`
...
**4. MCP Management**
   - Location: `desktop/src/pages/MCPPage.tsx`
