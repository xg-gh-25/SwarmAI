...
- [ ] 3. Implement the seed-copy startup fix

  - [ ] 3.1 Update `_ensure_database_initialized()` in `backend/main.py`
  ...
  - [ ] 3.2 Update `lifespan()` in `backend/main.py`
  ...
  - [ ] 3.3 Add `skip_init` parameter to `SQLiteDatabase.initialize()` in `backend/database/sqlite.py`
  ...
  - [ ] 3.4 Add `skip_schema` parameter to `initialize_database()` in `backend/database/__init__.py`
  ...
  - [ ] 3.5 Verify `generate_seed_db.py` output in `backend/scripts/generate_seed_db.py`
