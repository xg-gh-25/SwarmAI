...
local_modules = [
    ...
    'core.engine_metrics',
    'core.escalation',
    'core.pipeline_profiles',
    'core.proactive_learning',
    'core.proactive_scoring',
    ...
    'hooks.context_health_hook',
    'hooks.daily_activity_hook',
    'hooks.distillation_hook',
    'hooks.evolution_maintenance_hook',
    'hooks.evolution_trigger_hook',
    ...
    # Routers added post-v7
    'routers.escalations',
    'routers.jobs',
    'routers.pipelines',
    # Schemas added post-v7
    'schemas.pipeline_run',
    # Jobs system (imported by routers.jobs, routers.system, workspace_manager)
    'jobs',
    'jobs.__main__',
    'jobs.cron_utils',
    'jobs.dedup',
    'jobs.executor',
    'jobs.install_scheduler',
    'jobs.job_manager',
    'jobs.models',
    'jobs.paths',
    'jobs.scheduler',
    ...
    'jobs.system_jobs',
    'jobs.adapters',
    'jobs.adapters.github_releases',
    'jobs.adapters.hacker_news',
    ...
    'jobs.handlers.signal_digest',
    'jobs.handlers.signal_fetch',
    'jobs.handlers.skill_proposer',
    # Utils
    'utils',
    'utils.bundle_paths',
    'utils.diff_parser',
