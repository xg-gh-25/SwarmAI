...
export default function SettingsPage() {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      {/* Self-Evolution — always enabled, not user-configurable */}
      <section className="mb-8 bg-[var(--color-card)] rounded-lg p-6">
        <h2 className="text-lg font-semibold text-[var(--color-text)] mb-2">Self-Evolution</h2>
        <p className="text-sm text-[var(--color-text-muted)] mb-4">
          The agent autonomously builds new capabilities when it encounters gaps or optimization opportunities.
        </p>
        <div className="flex items-center justify-between p-3 bg-[var(--color-bg)] rounded-lg">
          <div>
            <label className="text-sm font-medium text-[var(--color-text)]">Status</label>
            <p className="text-xs text-[var(--color-text-muted)]">Always enabled — reactive, proactive, and stuck-detection triggers are active</p>
          </div>
          <span className="text-green-400 text-sm flex items-center gap-1">
            <span className="material-symbols-outlined text-sm">check_circle</span>
            Active
