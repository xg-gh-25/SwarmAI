...
def execute_job(
    ...
    try:
        if job.type == "signal_fetch":
        ...
        elif job.type == "eval_scheduled":
            from .handlers.eval_scheduled import run_eval_scheduled
            eval_result = run_eval_scheduled(
            ...
            todo_res = run_todo_resolution(
                ...
                working_stale_days=job.config.get("working_stale_days", 14),
