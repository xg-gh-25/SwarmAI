...
**All generated .pdf files and extracted content should be saved to:**
```
~/.swarm-ai/SwarmWS/Knowledge/Notes/
```

This is the designated location for draft PDFs and extracted data. Once finalized, documents can be moved to `Knowledge/Knowledge Base/`.
