...
titles, dated pointers, blow-by-blow→pattern+tell, CJK-in-system-prose), the red-line (never cut a correction's pattern+durable-tell or a principle kernel), and
