...
2. If the bug is a new pattern -- **append a new row** (RP20, RP21, etc.) to the table above. Include: trigger condition, what to verify, and the real bug as the example.
