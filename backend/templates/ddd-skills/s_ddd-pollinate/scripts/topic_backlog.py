...
from _ddd_paths import backlog_path as _backlog_path


DEFAULT_BACKLOG_PATH = str(_backlog_path())  # DDD-local: <workspace>/.artifacts/pollinate/backlog.json
...
def build_parser():
    parser = argparse.ArgumentParser(
        ...
        epilog='Backlog stored at <workspace>/.artifacts/pollinate/backlog.json'
    )
