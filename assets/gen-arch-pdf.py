...
story.append(Paragraph(
    ...
    "<b>Author:</b> REDACTED_NAME (XG) + Swarm (AI Co-Architect)<br/>"
...
story.append(Paragraph(
    ...
    "<b>Generated by:</b> Swarm (Claude Opus 4.6) under supervision of REDACTED_NAME (XG).<br/>"
