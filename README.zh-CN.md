...
- 55+ 个内置 skill（浏览器、PDF、Slack、Outlook、研究、代码审查…）
...
| 飞轮 | 做什么 |
|------|--------|
| **Self-Evolution** | 观察纠正 → 度量 skill 健康度 → LLM 自动优化。55+ 个 skill，12 个进化模块。 |
...
| **Skill** | 55+（邮件、日历、浏览器、PDF、研究…） | 工具调用 | 代码建议 |
...
**数据一览：** 800+ 次提交 · 60K+ 后端代码 · 55+ 个 skill · 3,000+ 个测试 · 70+ 个核心模块 · 11 个上下文文件 · 7 个会话后钩子
